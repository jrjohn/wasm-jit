...
fn main() {
    ...
    // contours. 老 = low f0 (~100Hz), slow syllables, a 4Hz tremor, extra air.
    {
        ...
        let verse: [Syl; 10] = [
            Syl { closure: 0.06, fric: Some((1600.0, 0.045, 0.04, 0.50)), vow: &[(0.0, 2.0)], nas: &[(0.0, 0.05)], tone: (1.02, 1.02, 1.0), dur: 0.62, gap: 0.08 }, // 孤 gū
            Syl { closure: 0.06, fric: Some((2800.0, 0.05, 0.10, 0.55)), vow: &[(0.0, 0.0), (0.55, 0.0), (1.0, 2.0)], nas: &[(0.0, 0.05)], tone: (1.0, 1.0, 0.99), dur: 0.68, gap: 0.08 }, // 舟 zhōu
            Syl { closure: 0.13, fric: Some((6000.0, 0.0, 0.14, 0.50)), vow: &[(0.0, 2.0), (0.45, 2.0), (1.0, 0.0)], nas: &[(0.0, 0.05)], tone: (1.0, 1.0, 1.0), dur: 0.72, gap: 0.08 }, // 蓑 suō
            Syl { closure: 0.05, fric: None, vow: &[(0.0, 2.0), (0.3, 3.0), (1.0, 3.0)], nas: &[(0.0, 0.5), (0.2, 0.1), (1.0, 0.05)], tone: (1.18, 0.9, 0.68), dur: 0.6, gap: 0.08 }, // 笠 lì
            Syl { closure: 0.0, fric: None, vow: &[(0.0, 2.0), (0.4, 4.0), (1.0, 0.0)], nas: &[(0.0, 0.1), (0.45, 0.15), (1.0, 0.92)], tone: (1.0, 1.0, 0.97), dur: 0.85, gap: 0.6 }, // 翁 wēng — caesura
            Syl { closure: 0.05, fric: Some((3000.0, 0.04, 0.03, 0.50)), vow: &[(0.0, 2.0)], nas: &[(0.0, 0.05)], tone: (0.85, 0.92, 1.12), dur: 0.6, gap: 0.08 }, // 獨 dú
            Syl { closure: 0.05, fric: Some((3200.0, 0.04, 0.03, 0.50)), vow: &[(0.0, 3.0), (0.45, 1.0), (1.0, 0.0)], nas: &[(0.0, 0.05)], tone: (1.2, 0.9, 0.66), dur: 0.7, gap: 0.08 }, // 釣 diào
            Syl { closure: 0.07, fric: Some((1400.0, 0.0, 0.09, 0.32)), vow: &[(0.0, 1.0)], nas: &[(0.0, 0.05), (0.6, 0.1), (1.0, 0.8)], tone: (0.84, 0.9, 1.1), dur: 0.72, gap: 0.08 }, // 寒 hán
            Syl { closure: 0.06, fric: Some((3700.0, 0.0, 0.08, 0.50)), vow: &[(0.0, 3.0), (0.5, 1.0), (1.0, 1.0)], nas: &[(0.0, 0.08), (0.55, 0.15), (1.0, 0.9)], tone: (1.0, 1.0, 0.98), dur: 0.75, gap: 0.08 }, // 江 jiāng
            Syl { closure: 0.10, fric: Some((4300.0, 0.0, 0.12, 0.50)), vow: &[(0.0, 3.0), (0.5, 4.0), (1.0, 4.0)], nas: &[(0.0, 0.05)], tone: (0.78, 0.68, 0.92), dur: 0.85, gap: 0.3 }, // 雪 xuě
        ];
        ...
        let wav = perform(&mut e, total, |b, e| {
            ...
            let tremor = 1.0 + 0.022 * (std::f32::consts::TAU * 4.3 * tt).sin()
                + 0.008 * (std::f32::consts::TAU * 0.7 * tt).sin();
