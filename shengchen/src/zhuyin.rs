...
fn initial(c: char) -> Option<Initial> {
    Some(match c {
        ...
        'ㄓ' => Initial { closure: 0.10, burst: Some((3100.0, 0.02, 0.85)), hiss: Some((3100.0, 0.10, 0.75)), locus: Some(3.3), ..NO_I },
        'ㄔ' => Initial { closure: 0.10, burst: Some((3100.0, 0.02, 0.85)), hiss: Some((3100.0, 0.14, 0.70)), locus: Some(3.3), ..NO_I },
        'ㄕ' => Initial { closure: 0.10, hiss: Some((3100.0, 0.12, 0.65)), locus: Some(3.3), ..NO_I },
