...
fn initial(c: char) -> Option<Initial> {
    Some(match c {
        ...
        'ㄓ' => Initial { closure: 0.11, hiss: Some((2600.0, 0.09, 0.70)), locus: Some(3.3), ..NO_I },
        'ㄔ' => Initial { closure: 0.11, hiss: Some((2600.0, 0.13, 0.65)), locus: Some(3.3), ..NO_I },
        'ㄕ' => Initial { closure: 0.10, hiss: Some((2800.0, 0.12, 0.55)), locus: Some(3.3), ..NO_I },
