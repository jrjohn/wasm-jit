...
fn initial(c: char) -> Option<Initial> {
    Some(match c {
        ...
        'ㄓ' => Initial { closure: 0.15, hiss: Some((3300.0, 0.12, 0.85)), locus: Some(3.3), ..NO_I },
        'ㄔ' => Initial { closure: 0.17, hiss: Some((3300.0, 0.14, 0.80)), locus: Some(3.3), ..NO_I },
        'ㄕ' => Initial { closure: 0.15, hiss: Some((3300.0, 0.13, 0.75)), locus: Some(3.3), ..NO_I },
